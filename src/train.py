...
# I need to bring in the generator class
def predict(generator, num_examples, save_path, model_path="../input/models/model50 GAN_normal0.01_batch32.pt", BATCH_SIZE=32, LATENT_SIZE=96):
    """
